import { ElementRef, EventEmitter, AfterViewInit, OnInit, OnDestroy, ChangeDetectorRef, AfterViewChecked } from '@angular/core';
 ...
 * @group Components
 */
export declare class InputTextarea implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
    el: ElementRef;
    ngModel: NgModel;
    control: NgControl;
    private cd;
