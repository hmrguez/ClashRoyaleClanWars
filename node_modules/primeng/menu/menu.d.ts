...
export declare class MenuItemContent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MenuItemContent, "[pMenuItemContent]", never, { "item": { "alias": "pMenuItemContent"; "required": false; }; "itemTemplate": { "alias": "itemTemplate"; "required": false; }; "id": { "alias": "id"; "required": false; }; }, { "onMenuItemClick": "onMenuItemClick"; }, never, never, false, never>;
}
/**
