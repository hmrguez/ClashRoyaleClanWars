    ...
    public static class CardsUpload
    {
        public static List<TroopModel> TroopsCards { get; } = new List<TroopModel>
        {
            ...
            {   Name="Knight",
                ...
                Amount=1,
                InitialLevel=1,
                Target=TargetEnum.Ground,
                Speed= SpeedEnum.Medium,
                Range=1.2f,
                HitSpeed=1.2f,
                Transport = TransportEnum.Ground,
        ...
        public static List<StructureModel> StructureCards { get; } = new List<StructureModel>()
        {
            ...
            {
                Name="Cannon",
                Type = DenominationEnum.Structure,
                Quality = QualityEnum.Common,
                Elixir=3,
                HitPoints=322,
                LifeTime=30,
