...
namespace ClashRoyaleClanWarsAPI.Infrastructure.Migrations
{
    ...
    [Migration("20231202162139_FixingClanWarRelationship")]
    partial class FixingClanWarRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClashRoyaleClanWarsAPI.Domain.Models.RoleModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0e4158cb-5118-49bc-8d8b-634b83a679d3"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("9972ecb9-9c4e-4c25-b225-1df7152355c2"),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("8ea53a55-3374-4f91-b908-6bc3e7c0ebd9"),
                            Name = "SuperAdmin"
                        });
                });
            ...
            modelBuilder.Entity("ClashRoyaleClanWarsAPI.Domain.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fc7b9856-8d1c-471a-82b9-28b57937590f"),
                            PasswordHash = "AQAAAAIAAYagAAAAEHVp0icU79hbXi5cBtUgZ87/SUaTEtPLOGRfT/yoQkaE/AucGOWB/RfuTIWeG/N5GQ==",
                            RoleId = new Guid("8ea53a55-3374-4f91-b908-6bc3e7c0ebd9"),
                            UserName = "superadmin"
                        });
                });
