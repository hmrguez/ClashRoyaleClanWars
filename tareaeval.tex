...
\begin{enumerate}
    ...
    \item Los usuarios del sistema pueden autenticarse con su nombre de usuario y contraseña, o se pueden registrar
        ...
        \includegraphics[width=1\textwidth]{log}
        \includegraphics[width=1\textwidth]{sign}
       
    \item Los ususarios pueden visualizar las cartas con sus propiedades
    \begin{center}
        \includegraphics[width=1\textwidth]{cards}
        \end{center}

    \item Los usuarios pueden visualizar gráficamente la popularidad del juego; es decir, pueden ver gráficamente la cantidad de batallas en el año. 
    Además, se pueden visualizar los 5 clanes más populares en una gráfica de pastel, y se puede visualizar en una gráfica de barras, la distribución de batallas ganadas por usuarios
...
\includegraphics[width=1\textwidth]{xlsx}
\includegraphics[width=1\textwidth]{csv}

\item Mostramos en una gráfica de líneas la populariad del juego (cantidad de batallas por mes por año). Esta gráfica se puede exportar a pdf.
FOTOOOOOOOOOOOOO

\item Mostramos en una gráfica de barras la distribución de batallas ganadas por jugador (cuántos jugadores tienen x cantidad de batallas ganadas). Esta gráfica se puede exportar a pdf.

\item Mostramos en una gráfica de pastel los 5 clanes más populares .Esta gráfica se puede exportar a pdf.
